...
def reset_live_display() -> None:
    """Resets live display state for starting a new game session."""
...
def render_live(
    ...
    try:
        ...
        # Check if running in an active IPython notebook kernel
    ...
    if in_ipython:
        try:
            ...
            # Fall back to CLI print if IPython rendering fails
            pass
